...
namespace Tanks.Complete
{
    public class GameManager : MonoBehaviour
    {
        ...
        private IEnumerator RoundStarting()
        {
            ...
            m_RoundNumber++;
            m_TitleText.text = (m_Language == Language.English ? "ROUND " : "ÐÀÓÍÄ ") + m_RoundNumber;
        ...
        private string EndMessage()
        {
            ...
            string message = m_Language == Language.English ? "DRAW!" : "ÍÈ×Üß!";

            // If there is a winner then change the message to reflect that.
            if (m_RoundWinner != null)
                message = m_RoundWinner.m_ColoredPlayerText + (m_Language == Language.English ? " WINS THE ROUND!" : " ÂÛÈÃÐÛÂÀÅÒ ÐÀÓÍÄ!");
            ...
            if (m_GameWinner != null)
                message = m_GameWinner.m_ColoredPlayerText + (m_Language == Language.English ? " WINS THE GAME!" : " ÂÛÈÃÐÛÂÀÅÒ ÈÃÐÓ!");
            ...
            if (m_TitleCanvas != null)
            {
                switch (m_Language)
                {
                    case Language.Russian:
                        m_GameNameText.text = "ÒÀÍÊÈ!";
                        m_SelectTankText.text = "Âûáðàòü Òàíê";
                        break;
